...
contract("CrowdsourcerFactory", accounts => {
  ...
  it("cost of creating simple crowdsourcer", async () => {
    ...
    await expectGas(web3, receipt.receipt.gasUsed).resolves.toBe(1869230);
  });
  ...
  it("cost of creating bigger crowdsourcer", async () => {
    ...
    await expectGas(web3, receipt.receipt.gasUsed).resolves.toBe(1994055);
  });
  ...
  it("cost of initializing crowdsourcer", async () => {
    ...
    await expectGas(web3, receipt.receipt.gasUsed).resolves.toBe(2355490);
  });
});
